<%-- 
    Document   : editarDetalleComprobante
    Created on : 29 nov. 2021, 22:43:04
    Author     : zurit
--%>
...
<html>
    <head>
        ...
        <title>Actualizar Detalle Comprobante</title>
        <script>
    ...
    <body>
        ...
        %>
        <h3 align="center">Actualizar Detalle Comprobante</h3>
        <a href="adminUsuario?action=salir" style="justify-content: flex-end; display: flex;">Salir</a>
        <form action="adminComprobante?action=editarDetalle" method="post" >
            <table align="center">
                <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="idComprobante" value="<c:out value="${detalle.idComprobante}" ></c:out>" readonly></td>
                    </tr>
                    <tr>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="precio" name="precio" value="<c:out value="${detalle.precio}" ></c:out>" readonly></td>
                </tr>
            </table>
            <p align="center">
